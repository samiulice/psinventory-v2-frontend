...
function addNewBrand(page, brands) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/brand/new', requestOptions)
...
function updateBrand(brand) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      btn.disabled = true;
      fetch('https://psinventory-v2.onrender.com/admin/inventory/brand/edit', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewProduct(page, brands, categories, products) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/product/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          console.log(data)
          if (data.error === true) {
...
function updateProduct(brands, categories, product) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/product/update', requestOptions)
        .then(response => response.json())
        .then(data => {
          console.log(data)
          if (data.error === true) {
...
function addNewCategory(page, categories) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/category/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            showErrorMessage(data.message)
...
function updateCategory(category, btnIndex) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      btn.innerHTML = 'processing <i class="fa fa-spinner fa-spin"></i>'
      btn.disabled = true;
      fetch('https://psinventory-v2.onrender.com/admin/inventory/category/update', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewService(src, services) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/service/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            showErrorMessage(data.message)
...
function updateService(serviceInfo, btnIndex) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/service/update', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewCustomer(page, customers) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/mis/customer/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            showErrorMessage(data.message)
...
function updateCustomer(cusInfo, btnIndex) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/mis/customer/update', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewEmployee(page, employees) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/hr/employee/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (page === "") {
            setTimeout(function () {
...
function updateEmployee(empInfo, btnIndex) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/hr/employee/update', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewSupplier(page, suppliers) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/mis/supplier/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            showErrorMessage(data.message)
...
function updateSupplier(supInfo, btnIndex) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/mis/supplier/update', requestOptions)
        .then(response => response.json())
        .then(data => {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewStakeHolder() {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/add-stake-holder', requestOptions)
        .then(response => response.json())
        .then(data => {
          console.log(data)
          if (data.error === true) {
...
function checkoutWarrantyProducts(warrantyHistoryID, productSerialNo, productSerialID) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/products/warranty/checkout', requestOptions)
        .then(response => response.json())
        .then(data => {
          console.log(data)
          if (data.error === true) {
...
function confirmWarrantyDeliveryProcess(warrantyHistoryID, productSerialID) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/products/warranty/delivery', requestOptions)
...
function cancelService(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/services/purchase/cancel', requestOptions)
        .then(response => response.json())
        .then(function (data) {
          if (data.error === true) {
            alertQuestion(data.message)
...
function addNewExpenseType(page, expenses) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/expenses/type/new', requestOptions)
        .then(response => response.json())
        .then(data => {
          console.log(data);
          if (data.error === true) {
...
function updateExpense(expenseType, btnIndex) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch('https://psinventory-v2.onrender.com/admin/inventory/expenses/type/update', requestOptions)
        .then(response => response.json())
        .then(data => {
